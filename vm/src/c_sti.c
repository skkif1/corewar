...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/01/21 18:18:01 by omotyliu          #+#    #+#             */
/*   Updated: 2018/01/21 18:18:04 by omotyliu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/op.h"

int g_valid_registry[2] = {1, 1};
...
int		get_first_st(const int *params, t_process *process)
{
	...
	if (params[1] == T_REG)
	{
		...
		{
			g_valid_registry[0] = 0;
		}
		g_valid_registry[0] = 2;
	}
	return (res);
}
...
void	sti(t_process *process)
{
	...
	if (validate_reqistry(value) && g_valid_registry[0] && g_valid_registry[1])
	{

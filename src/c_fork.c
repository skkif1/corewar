...
/*   Updated: 2018/01/28 21:34:30 by vrudakov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	fork_helper(t_process *child_process, t_process *process)
{
...
void	c_fork(t_process *process)
{
	...
	i = 0;
	param = ((short)bytes_to_int(process->counter + 1, 2)) % IDX_MOD +
			process->counter;
	...
	fork_helper(child_process, process);
}
